...
namespace Machine
{
    partial class DeviceMain
    {
        ...
        public bool D01Check(string DSN)
        {
            ...
            Notify(string.Format("SFCData:\n[1]DSN:{0}\n[2]IMEI1:{1}\n[3]IMEI2:{2}\n[4]SKU:{3}\n[5]UPC/EAN:{4}\n[6]SIMID:{5}\n[7]ESIMID:{6}\n[8]SoftwareVersion:{7}", DSN, dataserver.StationLoc[0].IMEI, dataserver.StationLoc[0].IMEI2, dataserver.StationLoc[0].Sku, dataserver.StationLoc[0].Upc,dataserver.StationLoc[0].SimID,dataserver.StationLoc[0].EsimID));
            return true;
        }
