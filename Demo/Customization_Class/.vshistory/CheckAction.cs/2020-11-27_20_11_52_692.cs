...
namespace Machine
{
    partial class DeviceMain
    {
        ...
        public bool D01Check(string DSN)
        {
            ...
            Notify(string.Format("SFCData:\n[1]DSN:{0}\n[2]IMEI1:{1}\n[3]IMEI2:{2}\n[4]SKU:{3}\n[5]UPC:{4}\n[6]ESIMID:{5}", DSN, dataserver.StationLoc[0].IMEI, dataserver.StationLoc[0].IMEI2, dataserver.StationLoc[0].Sku, dataserver.StationLoc[0].Upc,dataserver.StationLoc[0].EsimID));
            return true;
        }
        ...
        public string Test_GetReatilData(string DSN)
        {
            ...
            return string.Format("Get Retail Result:\n{0}\nIMEI1:{1}\n:SKU:{2}\nColor:{3}\nADD:{4}\nMemory:{5}\n", response, HttpHelper.GetjsonData(response, "imei1", true), HttpHelper.GetjsonData(response, "sku", true), HttpHelper.GetjsonData(response, "color", true), HttpHelper.GetjsonData(response, "add", true), HttpHelper.GetjsonData(response, "memory", true));
        }
