            ...
            if (CCDDetection)
            {
                ...
                for (int i = 0; i < result.Length; i++)
                {
                    if (!string.IsNullOrEmpty(result[i]))
                    {
                        ...
                        else if (!dataserver.StationLoc[1].EsimIDCheck && result[i].Contains(EsimID))
                        {   //SkuCheck = true;
                ...
                return dataserver.StationLoc[1].IMEICheck && dataserver.StationLoc[1].SkuCheck && dataserver.StationLoc[1].UpcCheck && dataserver.StationLoc[1].EsimIDCheck;
            }
            else
            {
                return true;
