...
namespace Machine
{
    partial class DeviceMain
    {
        ...
        ReCheck_01:
            ...
            count = 0;
        ReCheck_02:
            if (!Read_Barcode_Retail(dataserver.StationLoc[1].IMEI, dataserver.StationLoc[1].IMEI2,dataserver.StationLoc[1].Sku, dataserver.StationLoc[1].Upc, dataserver.StationLoc[1].EsimID, ccc.CCDDetection))
            {
