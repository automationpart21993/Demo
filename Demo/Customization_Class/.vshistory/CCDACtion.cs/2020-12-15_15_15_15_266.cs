    ...
    partial class DeviceMain
    {
        ...
        ReCheck_01:
            ...
            if (!Read_Memory_Retail(dataserver.StationLoc[1].Memory, dataserver.StationLoc[1].LanguageType, out ModelScore, ccc.CCDDetection))
            {
                ...
                Notify("检测段:CCD2侧面内存检测失败!", "D02:CCD2 Retail Size error!", NotifyType.Warn);
                dataserver.StationLoc[1].Message = MsgSelect("视觉识别:CCD2侧面内存检测失败!", "CCD Discern:CCD2 Retail Size error");
