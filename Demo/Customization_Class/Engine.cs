        ...
        public void Engine_D03()
        {
            while ((int)Status_D03 < 3 || (int)Status_D03 == 5)
            {
                ...
                NG_Action:
                    ...
                    //}
                    if (!string.IsNullOrEmpty(dataserver.StationLoc[2].ErrorCode))
                    {
                        string response = string.Empty;
                        http_D02.UploadPass(dataserver.StationLoc[2].DSN, SwitchDataToFail(dataserver.StationLoc[2].ErrorCode), out response);
                        dataserver.StationLoc[2].Message = string.Format("NG UpLoad:{0}", response);
                    }
