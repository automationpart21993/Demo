...
namespace Machine
{
    ...
    public class DataBit
    {
        ...
        private Boolean aTTNeedToCheck = false;

        public Boolean ATTNeedToCheck
        {
            get { return aTTNeedToCheck; }
            set { aTTNeedToCheck = value; }
        }

        private Boolean aTTCheck = false;

        public Boolean ATTCheck
        {
            get { return aTTCheck; }
            set { aTTCheck = value; }
        }
