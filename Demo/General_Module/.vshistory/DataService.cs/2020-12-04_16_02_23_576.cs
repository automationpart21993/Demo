...
namespace Machine
{
    ...
    public class DataBit
    {
        ...
        private String aTTSKU = string.Empty;

        public String ATTSKU
        {
            get { return aTTSKU; }
            set { aTTSKU = value; }
        }

        private String gPN = string.Empty;
        ...
        private String ccdATTSKU = string.Empty;

        public String CCDATTSKU
        {
            get { return ccdATTSKU; }
            set { ccdATTSKU = value; }
        }

        private String ccdGPN = string.Empty;

        public String CCDGPN
        {
            get { return ccdGPN; }
            set { ccdGPN = value; }
        }

        private String ccdPN = string.Empty;
        ...
        private String ccdSN = string.Empty;
        ...
        private Boolean aDDSCheck = false;

        public Boolean ADDSCheck
        {
            get { return aDDSCheck; }
            set { aDDSCheck = value; }
        }
        ...
        private Boolean aTTSKUNeedToCheck = false;

        public Boolean ATTSKUNeedToCheck
        {
            get { return aTTSKUNeedToCheck; }
            set { aTTSKUNeedToCheck = value; }
        }

        private Boolean aTTSKUCheck = false;

        public Boolean ATTSKUCheck
        {
            get { return aTTSKUCheck; }
            set { aTTSKUCheck = value; }
        }

        private Boolean gPNNeedToCheck = false;

        public Boolean GPNNeedToCheck
        {
            get { return gPNNeedToCheck; }
            set { gPNNeedToCheck = value; }
        }

        private Boolean gPNCheck = false;

        public Boolean GPNCheck
        {
            get { return gPNCheck; }
            set { gPNCheck = value; }
        }

        private Boolean pNNeedToCheck = false;

        public Boolean PNNeedToCheck
        {
            get { return pNNeedToCheck; }
            set { pNNeedToCheck = value; }
        }

        private Boolean pNCheck = false;

        public Boolean PNCheck
        {
            get { return pNCheck; }
            set { pNCheck = value; }
        }

        private Boolean sNNeedToCheck = false;

        public Boolean SNNeedToCheck
        {
            get { return sNNeedToCheck; }
            set { sNNeedToCheck = value; }
        }

        private Boolean sNCheck = false;

        public Boolean SNCheck
        {
            get { return sNCheck; }
            set { sNCheck = value; }
        }
        ...
        public bool DataSave()
        {
            ...
            try
            {
                ...
                title += "ImeiCheck" + ",";
                title += "Imei2AddS" + ",";
                title += "Imei2NeedToCheck" + ",";
                title += "Imei2Check" + ",";
                title += "SkuCheck" + ",";
                title += "Upc/EanCheck" + ",";
                title += "SimidNeedToCheck" + ",";
                title += "SimidCheck" + ",";
                title += "EsimidCheck" + ",";
                title += "SoftwareVersionNeedToCheck" + ",";
                title += "SoftwareVersionCheck" + ",";
                title += "ATTSKUNeedToCheck" + ",";
                title += "ATTSKUCheck" + ",";
                title += "GPNNeedToCheck" + ",";
                title += "GPNCheck" + ",";
                title += "PNNeedToCheck" + ",";
                title += "PNCheck" + ",";
                title += "SNNeedToCheck" + ",";
