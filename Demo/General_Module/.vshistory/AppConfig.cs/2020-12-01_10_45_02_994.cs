...
namespace Machine
{
    ...
    public class MachineConfig : Setting<MachineConfig>
    {
        ...
        [Category(NetworkSet), DisplayName("10-数据上传网址|UpLoad Pass URL"), Description("数据上传网址|UpLoad Pass URL")]
    ...
    public class CCDConfig : Setting<CCDConfig>
    {
        ...
        public double ModelScore_Type_Retail
        {
            ...
            set { modelScore_Type_Retail = value; }
        }
        ...
        public double ModelScore_Color_Retail
        {
            ...
            set { modelScore_Color_Retail = value; }
        }
        ...
        public double ModelScore_GLabel_Retail
        {
            ...
            set { modelScore_GLabel_Retail = value; }
        }
        ...
        public double ModelScore_Memory_Retail
        {
            ...
            set { modelScore_Memory_Retail = value; }
        }
        ...
        public double ModelScore_Size_Retail
        {
            ...
            set { modelScore_Size_Retail = value; }
        }
        ...
        public double ModelScore_Price_BOB
        {
            ...
            set { modelScore_Price_BOB = value; }
        }
        ...
        public double ModelScore_Date_BOB
        {
            ...
            set { modelScore_Date_BOB = value; }
        }

        #endregion

        private const String EVTSet = "06-训线设置|DVT Setting";
    ...
    public class ScalseConfig : Setting<ScalseConfig>
    {
        ...
        private double upperLimit_First = 12;
        ...
        public double UpperLimit_First
        {
            ...
            set { upperLimit_First = value; }
        }

        private double lowerLimit_First = 12;
